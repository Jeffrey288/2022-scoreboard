function seeker_score_template() {
    return `
    <div class="flex flex-row justify-between m-auto w-[84%]">
        <table class="w-[55%]">
            <tr>
            <td>
                <button class="restart-vio-button inline-block float-left">RESTART</button>
                <p class="restart-vio-text inline-block float-right">0</p></td>
            </tr>
            <tr>
            <td>                      
                <button class="restart-vio-button inline-block float-left">VIOLATION</button>
                <p class="restart-vio-text inline-block float-right">0</p>
            </td>
            </tr>
        </table>
        <button class="end-button">BUILT</button>
        </div>
        ...
        <table class="text-center items-center w-[100%]">
            ...
            <td rowspan="5">
                ...
                <button class="ball-clicked">3</button>
                </div>
            </td>
...
function hitter_score_template() {
    return `
    ...
    <table class="text-center items-center w-[100%] >lg:table-fixed">
        ...
        <td class="w-[27%]"><span class="criteria-text block">Collected</span>
            <span class="text-size-[40px] text-center font-bold block">2</span></td>
